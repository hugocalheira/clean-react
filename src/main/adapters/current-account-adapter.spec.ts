...
describe('CurrentAccountAdapter', () => {
  ...
  test('Should throw UnexpectedError if LocalStorageAdapter.set receive invalid params', () => {
    expect(() => setCurrentAccountAdapter(undefined)).toThrowError(UnexpectedError)
  })
